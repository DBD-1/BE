...
-- 프로젝트 6 (종료됨, 발주처 2) - 고객신용평가 미완료 시나리오용 ★요구사항에 있었던 코드
INSERT INTO PROJECT (PROJECT_ID, PROJECT_NAME, START_DATE, END_DATE, CLIENT_ID)
VALUES (SQ_PROJECT_ID.NEXTVAL, '코리아은행 웹 개발', DATE '2024-03-01', DATE '2024-12-20', 2);

-- 프로젝트 7 (종료됨, 발주처 3)
INSERT INTO PROJECT (PROJECT_ID, PROJECT_NAME, START_DATE, END_DATE, CLIENT_ID)
VALUES (SQ_PROJECT_ID.NEXTVAL, '글로벌전자 MES 고도화', DATE '2023-07-01', DATE '2024-02-28', 3);

-- 프로젝트 8 (진행 중, 발주처 4)
INSERT INTO PROJECT (PROJECT_ID, PROJECT_NAME, START_DATE, END_DATE, CLIENT_ID)
VALUES (SQ_PROJECT_ID.NEXTVAL, '스타트업A 데이터 분석 플랫폼 구축', DATE '2024-09-01', NULL, 4);

-- 프로젝트 9 (종료됨, 발주처 1)
INSERT INTO PROJECT (PROJECT_ID, PROJECT_NAME, START_DATE, END_DATE, CLIENT_ID)
VALUES (SQ_PROJECT_ID.NEXTVAL, '미래IT 보안 시스템 구축', DATE '2023-10-01', DATE '2024-09-30', 1);

-- 프로젝트 10 (진행 중, 발주처 2)
INSERT INTO PROJECT (PROJECT_ID, PROJECT_NAME, START_DATE, END_DATE, CLIENT_ID)
VALUES (SQ_PROJECT_ID.NEXTVAL, '코리아은행 차세대 대출 시스템', DATE '2025-01-01', NULL, 2);
